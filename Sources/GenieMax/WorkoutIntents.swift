...
/// can drive the live workout. GenieMax can't see the app's `WhoopBLE` singleton (that's in WhoopUI), so the app
/// registers the actual actions here at launch; the intents just invoke them. Shared in GenieMax so BOTH the app and
